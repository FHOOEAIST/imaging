...
package science.aist.imaging.opencv.imageprocessing.contrast;
...
public class OpenCVContrastFunction implements ImageFunction<Mat, Mat> {
    ...
    public ImageWrapper<Mat> apply(ImageWrapper<Mat> image) {
        ...
        return ((OpenCVFactory) ImageFactoryFactory.getImageFactory(Mat.class)).getImage(newM, image.getChannelType());
    }
}
