 ...
 */
public class MeanFilterTest extends OpenCVTest {

    @Test
    public void testApply() {
        // given
        ImageWrapper<Mat> compareImage = loadImageFromClassPath("/backgroundsubtraction/1/backgroundMean.tif");
        ...
        AbstractAveragingFilter abstractAveragingFilter = new MeanFilter();
