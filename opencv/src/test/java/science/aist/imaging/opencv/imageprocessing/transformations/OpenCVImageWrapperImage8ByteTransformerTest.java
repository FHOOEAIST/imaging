...
import science.aist.imaging.opencv.imageprocessing.transformers.OpenCVImageWrapperImage8ByteTransformer;
...
public class OpenCVImageWrapperImage8ByteTransformerTest extends OpenCVTest {
    ...
    public void testEightByteToCVImage() {
        ...
        ImageWrapper<double[][][]> i = ImageFactoryFactory.getImageFactory(double[][][].class).getImage(height, width, channelType, inputImage);
