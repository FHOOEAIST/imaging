...
/**
 * Unittest-class for {@link PositionObjectMerge}
 *
 * @author Christoph Praschl
 * @author Andreas Pointner
 */
public class PositionObjectMergeTest {

    @Test
    public void testMergeByPosition() {
        //GIVEN
        ...
        PositionObjectMerge<Double, Double> merge = new PositionObjectMerge<>();
    ...
    @Test
    public void testMergeByPositionThresholdFail() {
        //GIVEN
        //We have two different objects which should be merged.
        ...
        //WHEN
        RecognizedObject<Double, Double> merged = merge.merge(object1, object2, 3);
