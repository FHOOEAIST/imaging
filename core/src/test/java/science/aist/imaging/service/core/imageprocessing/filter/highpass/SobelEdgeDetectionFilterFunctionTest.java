...
public class SobelEdgeDetectionFilterFunctionTest {
    ...
    private final SobelEdgeDetectionFilterFunction<short[][][], short[][][]> sobelEdgeDetectionFilterFunction = new SobelEdgeDetectionFilterFunction<>(Image2ByteFactory.getInstance());
