...
/**
 * <p>Tests {@link GreyscaleLightnessConverter}</p>
 *
 * @author Andreas Pointner
 */
public class GreyscaleLightnessConverterTest {
    @Test
    public void testApply() {
        ...
        double blue = 10;
        double avg = 7;
        ColorToGreyScaleConverter greyScale = new GreyscaleLightnessConverter();
